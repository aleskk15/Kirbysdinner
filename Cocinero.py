...
from Cocinero_M import Cocinero_M
from Cocinero_P import Cocinero_P
...
class Cocinero:
    def __init__(self, objeto_archivo="kirby/kirbyVerde.obj", swap_yz=False):
        ...
        self.bebida_showing = False
        self.comida_showing = False
        self.tipo_comida = "hamburger.obj"
        ...
        self.manos = [
            Cocinero_M(position =[1.5, 0.1, 0.0], direction = "R"),
            Cocinero_M(position =[-1.5, 0.1, 0.0], direction = "L")
        ]

        self.pies = [
            Cocinero_P(position =[0.5, -1.7, 0.0], direction = "R"),
            Cocinero_P(position =[-0.8, -1.7, 0.0], direction = "L")
        ]
    ...
    def update(self, pos_x, pos_z):
        ...
        for mano in self.manos:
            if mano.direction == "L":
                mano.comida_showing = self.comida_showing
                mano.tipo_comida = self.tipo_comida
