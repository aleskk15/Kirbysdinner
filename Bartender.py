...
from Bartender_M import Bartender_M
from Bartender_P import Bartender_P
...
class Bartender:
    def __init__(self, objeto_archivo="kirby/kirbyAmarillo.obj", swap_yz=False):
        ...
        self.manos = [
            Bartender_M(position =[1.5, 0.1, 0.0], direction = "R"),
            Bartender_M(position =[-1.5, 0.1, 0.0], direction = "L")
        ]

        self.pies = [
            Bartender_P(position =[0.5, -1.7, 0.0], direction = "R"),
            Bartender_P(position =[-0.8, -1.7, 0.0], direction = "L")
        ]
    ...
    def update(self, pos_x, pos_z):
        ...
        for mano in self.manos:
            if mano.direction == "L":
                mano.bebida_showing = self.bebida_showing
