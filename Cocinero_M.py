...
class Cocinero_M:
    def __init__(self, objeto_archivo="kirby/manosVerde.obj", swap_yz=False, position = [0.0, 0.0, 0.0], direction = "L", moving= False):
        ...
        self.comida = Comida(self.tipo_comida)
        self.sarten = Sarten()
    ...
    def draw(self):
        ...
        if self.cooking: 
            if self.comida.up == False:
                self.comida.jump = 5
                self.comida.up = True
            else:
                self.comida.jump = 0
                self.comida.up = False
            if self.direction == "R":
                glRotatef(0, 0, 0, 1)
            else:
                glRotatef(0, 0, 0, 1)
        ...
        if self.comida_showing:
            self.comida.tipo_comida = self.tipo_comida
            print("DIBUJANDO COMIDA EN MANO")
            self.comida.draw()
            self.sarten.draw()  
