...
class Cliente_M:
    def __init__(self, objeto_archivo="princefluff/fluffBrazo.obj", swap_yz=False, position = [0.0, 0.0, 0.0], direction = "L", moving= False):
    ...
    def draw(self):
        ...
        if self.direction == "R":
            #glRotatef(180, 0, 1, 0) 
            right = np.array([
                [math.cos(180), 0, math.sin(180), 0],
                [0, 1, 0, 0],
                [-math.sin(180), 0, math.cos(180), 0],
                [0, 0, 0, 1]
            ])
            MC = MC @ right
        ...
        if self.moving:  
            ...
            moving = np.array([
                [1, 0, 0, 0],
                [0, 1, 0, math.cos(self.time)*self.radio],
                [0, 0, 1, math.sin(self.time)*self.radio],
                [0, 0, 0, 1]
            ])
        ...
        if self.eating and self.direction == "L": 
