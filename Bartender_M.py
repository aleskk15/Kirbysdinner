...
class Bartender_M:
    def __init__(self, objeto_archivo="kirby/manosAmarillo.obj", swap_yz=False, position = [0.0, 0.0, 0.0], direction = "L", moving= False):
    ...
    def draw(self):
        ...
        if self.bebida_showing:
            print("DIBUJANDO BEBIDA EN MANO")
            self.bebida.draw()  
